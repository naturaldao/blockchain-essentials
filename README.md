...
最近我们达成的共识是：成功有个常被忽略的元素叫勇气(courage)。当我们有勇气时，我们就可以无惧面对传统智慧——这显然同样适用于区块链的学习与实践。
...
我并不建议大家去买比特币或者马斯克数次提到的狗狗币，他们的使命已经完成并且未来也很难进入区块链主流市场。不过区块链的确和“币”息息相关，我们已经看到：几乎每个区块链项目都至少有一个自己的“币种”，因为不少项目都是独一无二的创新项目，那么这些币种在市场里的表现也确实很香：
...
请注意，我一直在并还将继续推荐年轻人都去推特关注@elonmusk，这是因为他就是皇帝的新衣里面的那个小孩（虽然也有极坏的缺陷）。另外还请注意，我并不认为未来区块链的每个项目都需要一个自己的专属代币。但每个项目都发行代币是区块链上位的一个必需的策略，它非常可能是过渡性的策略，多一点批判的眼光，才是我们跟上区块链发展的法宝。
