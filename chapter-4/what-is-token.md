...
**综上所述，通证，就是通过加密技术、共识规则、智能合约、应用目标等建立起来的集货币属性、价值属性、荣誉属性、安保属性、确权属性等等多种属性于一体的区块链凭证。通证可以为智能合约所管理，也可以为握有钱包私钥的人所拥有和使用。通证是区块链的硬核之一。目前区块链里面已经出现同质通证（FT）、非同质通证（NFT）两大类通证。**
