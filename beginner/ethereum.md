...
The consequences of The DAO event have become even worse! Including Vitalik, 11,000 capitalists have shown the world how they ruthlessly trampled on the core values of the blockchain, such as censorship resistance, built through Satoshi Nakamoto's painstaking practice, to ensure their own interests. Yes, Ethereum capitalists' exemplary actions have hindered the entire industry for ten years, even allowing many scammers to run rampant and harm many people. It has also brought shame to Satoshi Nakamoto!
