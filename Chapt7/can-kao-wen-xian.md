...
因此，更为神奇的是，中本聪对于比特币公共奖励基金的设计思想，意义非凡！它最终会启发人们，按照比特币的工作量证明的这一治理共识所构建的，不是资本主义，而是人类社会的一个新文明！
...
#### 公开透明（Transparent & Public）

这一点，在白皮书的“2. 交易”里。\
比特币就是一个公开透明的去中心化账单系统，它把账单完全公开透明地交给全球所有的比特币用户监管。比特币的所有转账数据是公开透明的，比特币的所有全节点钱包的代码也都是公开透明的，虽然这样其实还不够可靠。
