...
整个行业都翘首以盼分片能够大大提升以太坊的性能。早在《BeyondBlock Taipei 2017》会议上， Vitalik 就已经开始推动这一技术更新。整整七年过去，实际发生的却是 ETH 2.0 的流产。
...
3. UTO是ERC-20类型的通证。也就是说，中本聪UTO基金里的公共治理基金是通过智能合约等来实现其最终的去中心化自治。
